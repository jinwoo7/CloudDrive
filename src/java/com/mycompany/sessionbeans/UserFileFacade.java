...
public class UserFileFacade extends AbstractFacade<UserFile> {
    ...
    /*
    Annotating 'private EntityManager em;' with '@PersistenceContext(unitName = "CloudDrive-YomPU")' implies that
    the EntityManager instance pointed to by 'em' is associated with the 'CloudDrive-YomPU' persistence context. 
     ...
     */
    @PersistenceContext(unitName = "CloudDrive-YomPU")
